<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="email" id="email"  value="{{$ticket->email}}">          
      </div>
            <div class="form-group">
              <label for="category">Category</label>
              <input type="text" class="form-control" name="category" id="category"  value="{{$ticket->category}}">          
          </div>
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="text" class="form-control" name="description" id="description" value="{{$ticket->description}}">          
            </div>
            <div class="form-group">
